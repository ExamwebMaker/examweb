                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if(response.success){
                            ...
                            $('#form-body').find('input:eq(0)').val(response.data.id)
                            $('#form-body').find('input:eq(1)').val(response.data.name)
                            $('#form-body').find('input:eq(2)').val(response.data.nameSpell)
                            $('#form-body').find('input:eq(3)').val(response.data.examWay)
                            $('#form-body').find('input:eq(4)').val(response.data.policy)
                            $('#form-body').find('input:eq(5)').val(response.data.zhaoshengUnit)
                            $('#form-body').find('input:eq(6)').val(response.data.specialPlan)
                            $('#form-body').find('input:eq(7)').val(response.data.nation)
                            $('#form-body').find('input:eq(8)').val(response.data.wantDepartmentName)
                            $('#form-body').find('input:eq(9)').val(response.data.wantMajorName)
                            $('#form-body').find('input:eq(10)').val(response.data.examSubject)
                            $('#form-body').find('input:eq(11)').val(response.data.learnWay)
                            $('#form-body').find('input:eq(12)').val(response.data.researchWay)
                            $('#form-body').find('input:eq(13)').val(response.data.examPointName)
                            $('#form-body').find('input:eq(14)').val(response.data.examPointAddress)
                        }else{
                            response.message
                        }
                    },
